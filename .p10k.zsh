# Generated by Powerlevel10k configuration wizard on 2020-03-04 at 17:47 CST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 4928.
# Wizard options: nerdfont-complete + powerline, small icons, classic, unicode, dark,
# time, slanted separators, slanted heads, slanted tails, 2 lines, dotted, left frame,
